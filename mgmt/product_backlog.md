...
| <p id="1020"> 1020 </p> | DevOps | As Dina, I want to have a running Kubernetes cluster or VM so that the software can be rolled out. | <ul><li>First "example" deployment is done</li><li>GitOPS CICD is elaborated</li><li>Decision VM vs K8s is made</li></ul> | 5 | 1 | Planned | 🔴 |
