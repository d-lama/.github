...
| 1009 | Development | As Eduardo and Hanna, I want to be able to see the progress (how much of the data to be labeled is already labeled). Thereby as Kevin I should see my progress and as Katharina I want to see the progress of Kevin and Noah, but also an overall view | - | - | 2 | Backlog | 🟢🟣 |
| 1014 | Development | As Hanna I want to download the labeled data via a button so I can use it e.g. in Python to do ML | - | - | 2 | Backlog | 🟢 |
| 1003 | Development | As Eduardo, I want to get scores for my labeled data so I can see how much data I have already assigned to a category. | - | - | 3 | Backlog | 🟣 |
| 1010 | Development | As a Eduardo, I would like to see a ranking of how much and how well I have labled versus other Eduardos so I can compete with them. | - | - | 3 | Backlog | 🟣 |
| 1017 | Development | As Hanna, I would like to have a control algorithm that can check the quality of the labeld data from Eduardo so that I can exclude low-flyers to maintain data quality. (e.g. control question to which the answer is known). | - | - | 3 | Backlog | 🟢 |
| 1021 | Development | As Hanna, I want to be able to make a labeling record public or private so I can control the audience who is labeling my data. | - | - | 3 | Backlog | 🟢 |
| 1006 | Development | As Eduardo, I would like to have an overview of the labelig records and be able to choose one from them. | - | - | 4 | Backlog | 🟣 |
| 1012 | Development | As Hanna, I want to be able to upload different data formats (text, images, audio, video) so that Eduardo can label different records for different usecases. | - | - | 4 | Backlog | 🟢 |
| 1015 | Development | As Hanna, I would like to have a REST / gRPC interface so that I can use the labeled data directly without downloading them to feed an ML processes. | - | - | 4 | Backlog | 🟢 |
